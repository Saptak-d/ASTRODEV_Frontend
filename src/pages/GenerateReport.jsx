  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-12">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-extrabold tracking-widest text-[#2A1B18] uppercase">Reveal Your Sacred Kundali</h1>
        <p className="text-sm text-gray-500 italic mt-1">Please share your birth details below to align with your cosmic path.</p>
      </div>
